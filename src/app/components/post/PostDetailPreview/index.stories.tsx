...
import PostDetailPreview from './index';
import { ImageSrcUrl } from '../../../utils/images';

const meta: ComponentMeta<typeof PostDetailPreview> = {
    title: 'Components/Post/PostDetailPreview',
...
export const Default: PPStory = {
    ...
    render: args => <PostDetailPreview {...args} />,
};
